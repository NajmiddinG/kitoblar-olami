...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(999, 850)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/image/book.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        MainWindow.setWindowIcon(icon)
        MainWindow.setStyleSheet("background-color: rgb(21, 21, 22); \n"
"")
        ...
        self.pushButton_5.setStyleSheet("background-color:rgb(31, 118, 28);")
        ...
        self.pushButton.setStyleSheet("background-color: rgb(160, 20, 20)")
        ...
        self.pushButton_2.setStyleSheet("background-color: rgb(31, 118, 28)")
        ...
        self.pushButton_3.setStyleSheet("background-color: rgb(31, 118, 28)")
        ...
        self.gridLayout_1.addWidget(self.tabWidget, 2, 0, 1, 1)
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setEnabled(True)
        self.label.setMinimumSize(QtCore.QSize(500, 70))
        self.label.setMaximumSize(QtCore.QSize(3000, 70))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Kitob savdo"))
        self.lineEdit_2.setPlaceholderText(_translate("MainWindow", "Kitob nomi yoki scanner ..."))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600;\">Kitob qidirish</span></p></body></html>"))
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Saqlash"))
        ...
        item.setText(_translate("MainWindow", "Qoldiq"))
        self.pushButton_6.setText(_translate("MainWindow", "  Kirim  "))
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\">&quot;Kitoblar olami&quot; magazini</p></body></html>"))
from icons import images_rc
